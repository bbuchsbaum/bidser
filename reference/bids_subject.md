...
#> [1] "/tmp/RtmpBHZWsl/bids_example_ds001/sub-01/func/sub-01_task-balloonanalogrisktask_run-01_bold.nii.gz"
#> [2] "/tmp/RtmpBHZWsl/bids_example_ds001/sub-01/func/sub-01_task-balloonanalogrisktask_run-02_bold.nii.gz"
#> [3] "/tmp/RtmpBHZWsl/bids_example_ds001/sub-01/func/sub-01_task-balloonanalogrisktask_run-03_bold.nii.gz"
# }
# \donttest{
tryCatch({
  ds001_path <- get_example_bids_dataset("ds001")
